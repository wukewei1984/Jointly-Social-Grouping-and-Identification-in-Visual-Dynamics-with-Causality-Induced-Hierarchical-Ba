...
path = '/media/a5/image1/lj/result'
class Config(object):
    """
    ...
    def __init__(self, dataset_name):
        ...
        if dataset_name=='volleyball':
            self.data_path='/home/a5/lj/data/videos'   #data path for the volleyball dataset
            self.train_seqs = [1]
                # ,3,6,7,10,13,15,16,18,22,23,31,32,36,38,39,40,41,42,48,50,52,53,54,
        ...
        self.train_learning_rate = 2.5e-5  # initial learning rate
        self.lr_plan = {41: 1.25e-5, 81: 6.125e-6, 121: 1.25e-6}  # change learning rate in these epochs
    ...
    def init_config(self, need_new_folder=True):
        ...
        self.result_path=path+'/%s'%self.exp_name
        self.log_path=path+'/%s/log.txt'%self.exp_name
