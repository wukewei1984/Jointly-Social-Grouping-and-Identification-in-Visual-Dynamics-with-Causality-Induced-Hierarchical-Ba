...
class Basenet_volleyball(nn.Module):
    ...
    def forward(self,batch_data):
        ...
        # print("images_in.shape:{}".format(images_in.shape))
        ...
        # print("features_multiscale:{}".format(features_multiscale.shape))
...
#         features_multiscale.requires_grad=False
        ...
        # print("boxes_features.shape:{}".format(boxes_features.shape))
        boxes_features=boxes_features.reshape(B*T*N,-1) # B*T*N, D*K*K
        # print("box_feature_reshape:{}".format(boxes_features.shape))
            
        # Embedding to hidden state
        boxes_features=self.fc_emb(boxes_features)  # B*T*N, NFB
        # print("box_feature_fc:{}".format(boxes_features.shape))
        boxes_features=F.relu(boxes_features)
        # print("box_feature_relu:{}".format(boxes_features.shape))
        boxes_features=self.dropout_emb(boxes_features)
        # print("box_feature_drop:{}".format(boxes_features.shape))
    
        boxes_states=boxes_features.reshape(B,T,N,NFB)
        # print("box_feature_rereshape:{}".format(boxes_features.shape))
